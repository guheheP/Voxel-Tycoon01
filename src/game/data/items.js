...
export const ItemBlueprints = {
  ...
  // --- Tier 1: 草原・基本 (10種) ---
  wood:           { id: 'wood',           name: '木材',           type: 'material', tier: 1, baseValue: 4  },
  stone:          { id: 'stone',          name: '石材',           type: 'material', tier: 1, baseValue: 4  },
  herb:           { id: 'herb',           name: '薬草',           type: 'material', tier: 1, baseValue: 6  },
  slime_jelly:    { id: 'slime_jelly',    name: 'スライムゼリー',   type: 'material', tier: 1, baseValue: 8  },
  clay:           { id: 'clay',           name: '粘土',           type: 'material', tier: 1, baseValue: 3  },
  flower_petal:   { id: 'flower_petal',   name: '花びら',          type: 'material', tier: 1, baseValue: 5  },
  bug_shell:      { id: 'bug_shell',      name: '虫の殻',          type: 'material', tier: 1, baseValue: 6  },
  feather_small:  { id: 'feather_small',  name: '小さな羽根',       type: 'material', tier: 1, baseValue: 5  },
  sand:           { id: 'sand',           name: '砂',             type: 'material', tier: 1, baseValue: 3  },
  mushroom:       { id: 'mushroom',       name: 'キノコ',          type: 'material', tier: 1, baseValue: 7  },

  // --- Tier 2: 洞窟・丘陵 (10種) ---
  iron_ore:       { id: 'iron_ore',       name: '鉄鉱石',          type: 'material', tier: 2, baseValue: 12 },
  cloth:          { id: 'cloth',          name: '魔法の布',         type: 'material', tier: 2, baseValue: 10 },
  crystal:        { id: 'crystal',        name: '水晶',            type: 'material', tier: 2, baseValue: 15 },
  poison_herb:    { id: 'poison_herb',    name: '毒草',            type: 'material', tier: 2, baseValue: 14 },
  silver_ore:     { id: 'silver_ore',     name: '銀鉱石',           type: 'material', tier: 2, baseValue: 16 },
  moss_stone:     { id: 'moss_stone',     name: '苔石',            type: 'material', tier: 2, baseValue: 11 },
  spider_silk:    { id: 'spider_silk',    name: '蜘蛛の糸',         type: 'material', tier: 2, baseValue: 13 },
  dark_stone:     { id: 'dark_stone',     name: '暗黒石',           type: 'material', tier: 2, baseValue: 15 },
  bone:           { id: 'bone',           name: '古びた骨',         type: 'material', tier: 2, baseValue: 10 },
  amber:          { id: 'amber',          name: '琥珀',            type: 'material', tier: 2, baseValue: 14 },
  ...
  // ===== Rank 1: 初期レシピ (8種) =====
  sword:            { id: 'sword',            name: '鉄の剣',         type: 'equipment',  baseValue: 35  },
  shield:           { id: 'shield',           name: '木の盾',         type: 'equipment',  baseValue: 25  },
  potion:           { id: 'potion',           name: '回復薬',         type: 'consumable', baseValue: 18  },
  wooden_bow:       { id: 'wooden_bow',       name: '木の弓',         type: 'equipment',  baseValue: 30  },
  herb_tea:         { id: 'herb_tea',         name: 'ハーブティー',     type: 'consumable', baseValue: 12  },
  stone_axe:        { id: 'stone_axe',        name: '石斧',           type: 'equipment',  baseValue: 28  },
  clay_pot:         { id: 'clay_pot',         name: '粘土の壺',        type: 'accessory',  baseValue: 15  },
  bug_lantern:      { id: 'bug_lantern',      name: '虫のランタン',     type: 'accessory',  baseValue: 20  },

  // ===== Rank 2: 洞窟解放 (10種) =====
  fire_sword:       { id: 'fire_sword',       name: '炎の剣',          type: 'equipment',  baseValue: 80  },
  ice_shield:       { id: 'ice_shield',       name: '氷の盾',          type: 'equipment',  baseValue: 65  },
  antidote:         { id: 'antidote',         name: '解毒薬',          type: 'consumable', baseValue: 30  },
  silver_dagger:    { id: 'silver_dagger',    name: '銀の短剣',         type: 'equipment',  baseValue: 55  },
  leather_armor:    { id: 'leather_armor',    name: '革鎧',            type: 'equipment',  baseValue: 60  },
  iron_spear:       { id: 'iron_spear',       name: '鉄の槍',          type: 'equipment',  baseValue: 50  },
  amber_ring:       { id: 'amber_ring',       name: '琥珀の指輪',       type: 'accessory',  baseValue: 45  },
  bone_charm:       { id: 'bone_charm',       name: '骨のお守り',       type: 'accessory',  baseValue: 35  },
  stamina_drink:    { id: 'stamina_drink',    name: 'スタミナドリンク',   type: 'consumable', baseValue: 25  },
  iron_helm:        { id: 'iron_helm',        name: '鉄兜',            type: 'equipment',  baseValue: 48  },
...
export const Recipes = {
  ...
  bug_lantern: { id: 'r_bug_lantern', targetId: 'bug_lantern', materials: ['bug_shell', 'slime_jelly'],  unlocked: true,  apCost: 1 },
