...
export const ItemBlueprints = {
  ...
  // --- Tier 4: 深海・竜の巣 (10種) ---
  deep_pearl: { id: 'deep_pearl', name: '深海の真珠', type: 'material', tier: 4, baseValue: 55, image: '/art/items/deep_pearl.png' },
  moonstone: { id: 'moonstone', name: '月光石', type: 'material', tier: 4, baseValue: 60, image: '/art/items/moonstone.png' },
  wind_crystal: { id: 'wind_crystal', name: '風の結晶', type: 'material', tier: 4, baseValue: 50, image: '/art/items/wind_crystal.png' },
  coral_fragment: { id: 'coral_fragment', name: '古代珊瑚', type: 'material', tier: 4, baseValue: 45, image: '/art/items/coral_fragment.png' },
  mithril_ore: { id: 'mithril_ore', name: 'ミスリル鉱', type: 'material', tier: 4, baseValue: 65, image: '/art/items/mithril_ore.png' },
  void_shard: { id: 'void_shard', name: '虚空の欠片', type: 'material', tier: 4, baseValue: 55, image: '/art/items/void_shard.png' },
  elder_bark: { id: 'elder_bark', name: '長老樹の樹皮', type: 'material', tier: 4, baseValue: 48, image: '/art/items/elder_bark.png' },
  sea_serpent_fin: { id: 'sea_serpent_fin', name: '海竜のヒレ', type: 'material', tier: 4, baseValue: 58, image: '/art/items/sea_serpent_fin.png' },
  frozen_tear: { id: 'frozen_tear', name: '凍れる涙', type: 'material', tier: 4, baseValue: 52, image: '/art/items/frozen_tear.png' },
  black_lotus: { id: 'black_lotus', name: '黒蓮華', type: 'material', tier: 4, baseValue: 62, image: '/art/items/black_lotus.png' },
  ...
  rainbow_scale: { id: 'rainbow_scale', name: '虹色の鱗', type: 'material', tier: 5, baseValue: 85, image: '/art/items/rainbow_scale.png' },
  star_dust: { id: 'star_dust', name: '星屑', type: 'material', tier: 5, baseValue: 75, image: '/art/items/star_dust.png' },
  world_tree_sap: { id: 'world_tree_sap', name: '世界樹の樹液', type: 'material', tier: 5, baseValue: 100, image: '/art/items/world_tree_sap.png' },
  divine_ore: { id: 'divine_ore', name: '神鉄鉱', type: 'material', tier: 5, baseValue: 95, image: '/art/items/divine_ore.png' },
  chaos_crystal: { id: 'chaos_crystal', name: '混沌の結晶', type: 'material', tier: 5, baseValue: 88, image: '/art/items/chaos_crystal.png' },
  phoenix_ash: { id: 'phoenix_ash', name: '不死鳥の灰', type: 'material', tier: 5, baseValue: 92, image: '/art/items/phoenix_ash.png' },
  aether_essence: { id: 'aether_essence', name: 'エーテルの精', type: 'material', tier: 5, baseValue: 110, image: '/art/items/aether_essence.png' },
  primordial_gem: { id: 'primordial_gem', name: '始原の宝玉', type: 'material', tier: 5, baseValue: 120, image: '/art/items/primordial_gem.png' },
  ...
  chainmail: { id: 'chainmail', name: '鎖帷子', type: 'equipment', baseValue: 100, image: '/art/items/chainmail.png' },
  elixir: { id: 'elixir', name: '万能薬', type: 'consumable', baseValue: 75, image: '/art/items/elixir.png' },
  wind_bow: { id: 'wind_bow', name: '風の弓', type: 'equipment', baseValue: 95, image: '/art/items/wind_bow.png' },
  spirit_robe: { id: 'spirit_robe', name: '精霊のローブ', type: 'equipment', baseValue: 110, image: '/art/items/spirit_robe.png' },
  strength_potion: { id: 'strength_potion', name: '力の薬', type: 'consumable', baseValue: 55, image: '/art/items/strength_potion.png' },
  spider_cloak: { id: 'spider_cloak', name: '蜘蛛糸のマント', type: 'equipment', baseValue: 85, image: '/art/items/spider_cloak.png' },
  crystal_orb: { id: 'crystal_orb', name: '水晶の宝珠', type: 'accessory', baseValue: 90, image: '/art/items/crystal_orb.png' },
  dark_blade: { id: 'dark_blade', name: '暗黒の刃', type: 'equipment', baseValue: 105, image: '/art/items/dark_blade.png' },
  ...
  magic_ink: { id: 'magic_ink', name: '魔法のインク', type: 'consumable', baseValue: 40, image: '/art/items/magic_ink.png' },

  // ===== Rank 4: 火山解放 (12種) =====
  holy_sword: { id: 'holy_sword', name: '聖剣', type: 'equipment', baseValue: 250, image: '/art/items/holy_sword.png' },
  dragon_armor: { id: 'dragon_armor', name: '竜鱗の鎧', type: 'equipment', baseValue: 220, image: '/art/items/dragon_armor.png' },
  phoenix_feather_acc: { id: 'phoenix_feather_acc', name: '不死鳥のお守り', type: 'accessory', baseValue: 180, image: '/art/items/phoenix_feather_acc.png' },
  flame_lance: { id: 'flame_lance', name: '炎の槍', type: 'equipment', baseValue: 200, image: '/art/items/flame_lance.png' },
  moonlight_staff: { id: 'moonlight_staff', name: '月光の杖', type: 'equipment', baseValue: 190, image: '/art/items/moonlight_staff.png' },
  silver_mail: { id: 'silver_mail', name: '銀糸の鎧', type: 'equipment', baseValue: 210, image: '/art/items/silver_mail.png' },
  spirit_potion: { id: 'spirit_potion', name: '霊薬', type: 'consumable', baseValue: 120, image: '/art/items/spirit_potion.png' },
  thunder_hammer: { id: 'thunder_hammer', name: '雷鳴のハンマー', type: 'equipment', baseValue: 230, image: '/art/items/thunder_hammer.png' },
  cursed_ring: { id: 'cursed_ring', name: '呪いの指輪', type: 'accessory', baseValue: 160, image: '/art/items/cursed_ring.png' },
  ...
  enchant_scroll: { id: 'enchant_scroll', name: '付呪の巻物', type: 'consumable', baseValue: 140, image: '/art/items/enchant_scroll.png' },

  // ===== Rank 5: 深海解放 (12種) =====
  trident: { id: 'trident', name: '海神の三叉槍', type: 'equipment', baseValue: 320, image: '/art/items/trident.png' },
  coral_armor: { id: 'coral_armor', name: '珊瑚の鎧', type: 'equipment', baseValue: 280, image: '/art/items/coral_armor.png' },
  pearl_tiara: { id: 'pearl_tiara', name: '真珠のティアラ', type: 'accessory', baseValue: 250, image: '/art/items/pearl_tiara.png' },
  tidal_bow: { id: 'tidal_bow', name: '潮流の弓', type: 'equipment', baseValue: 300, image: '/art/items/tidal_bow.png' },
  deep_elixir: { id: 'deep_elixir', name: '深海の霊薬', type: 'consumable', baseValue: 200, image: '/art/items/deep_elixir.png' },
  mithril_sword: { id: 'mithril_sword', name: 'ミスリルの剣', type: 'equipment', baseValue: 350, image: '/art/items/mithril_sword.png' },
  mithril_shield: { id: 'mithril_shield', name: 'ミスリルの盾', type: 'equipment', baseValue: 310, image: '/art/items/mithril_shield.png' },
  void_amulet: { id: 'void_amulet', name: '虚空のアミュレット', type: 'accessory', baseValue: 270, image: '/art/items/void_amulet.png' },
  frost_blade: { id: 'frost_blade', name: '凍てつく刃', type: 'equipment', baseValue: 290, image: '/art/items/frost_blade.png' },
  ...
  lotus_perfume: { id: 'lotus_perfume', name: '黒蓮の香水', type: 'consumable', baseValue: 180, image: '/art/items/lotus_perfume.png' },

  // ===== Rank 6: 竜の巣解放 (12種) =====
  dragon_slayer: { id: 'dragon_slayer', name: '竜殺しの大剣', type: 'equipment', baseValue: 450, image: '/art/items/dragon_slayer.png' },
  storm_cloak: { id: 'storm_cloak', name: '嵐のマント', type: 'equipment', baseValue: 380, image: '/art/items/storm_cloak.png' },
  ancient_crown: { id: 'ancient_crown', name: '古代王の冠', type: 'accessory', baseValue: 420, image: '/art/items/ancient_crown.png' },
  sage_stone: { id: 'sage_stone', name: '賢者の石', type: 'consumable', baseValue: 350, image: '/art/items/sage_stone.png' },
  mystic_amulet: { id: 'mystic_amulet', name: '神秘のアミュレット', type: 'accessory', baseValue: 400, image: '/art/items/mystic_amulet.png' },
  dragon_bow: { id: 'dragon_bow', name: '竜骨の弓', type: 'equipment', baseValue: 430, image: '/art/items/dragon_bow.png' },
  phoenix_robe: { id: 'phoenix_robe', name: '不死鳥のローブ', type: 'equipment', baseValue: 410, image: '/art/items/phoenix_robe.png' },
  void_blade: { id: 'void_blade', name: '虚無の剣', type: 'equipment', baseValue: 460, image: '/art/items/void_blade.png' },
  dragon_potion: { id: 'dragon_potion', name: '竜の血薬', type: 'consumable', baseValue: 300, image: '/art/items/dragon_potion.png' },
  thunder_spear: { id: 'thunder_spear', name: '雷光の槍', type: 'equipment', baseValue: 440, image: '/art/items/thunder_spear.png' },
  cursed_crown: { id: 'cursed_crown', name: '呪王の冠', type: 'accessory', baseValue: 360, image: '/art/items/cursed_crown.png' },
  scale_shield: { id: 'scale_shield', name: '竜鱗の大盾', type: 'equipment', baseValue: 390, image: '/art/items/scale_shield.png' },

  // ===== Rank 7: 天空解放 (12種) =====
  sky_sword: { id: 'sky_sword', name: '天空の剣', type: 'equipment', baseValue: 600, image: '/art/items/sky_sword.png' },
  time_hourglass: { id: 'time_hourglass', name: '時の砂時計', type: 'accessory', baseValue: 550, image: '/art/items/time_hourglass.png' },
  star_shield: { id: 'star_shield', name: '星盾', type: 'equipment', baseValue: 520, image: '/art/items/star_shield.png' },
  divine_armor: { id: 'divine_armor', name: '神鉄の鎧', type: 'equipment', baseValue: 580, image: '/art/items/divine_armor.png' },
  aether_staff: { id: 'aether_staff', name: 'エーテルの杖', type: 'equipment', baseValue: 560, image: '/art/items/aether_staff.png' },
  sky_bow: { id: 'sky_bow', name: '天翔ける弓', type: 'equipment', baseValue: 540, image: '/art/items/sky_bow.png' },
  rainbow_robe: { id: 'rainbow_robe', name: '虹のローブ', type: 'equipment', baseValue: 530, image: '/art/items/rainbow_robe.png' },
  divine_elixir: { id: 'divine_elixir', name: '神酒', type: 'consumable', baseValue: 400, image: '/art/items/divine_elixir.png' },
  chaos_ring: { id: 'chaos_ring', name: '混沌の指輪', type: 'accessory', baseValue: 480, image: '/art/items/chaos_ring.png' },
  star_pendant: { id: 'star_pendant', name: '星のペンダント', type: 'accessory', baseValue: 500, image: '/art/items/star_pendant.png' },
  wind_lance: { id: 'wind_lance', name: '疾風の槍', type: 'equipment', baseValue: 570, image: '/art/items/wind_lance.png' },
  phoenix_bow: { id: 'phoenix_bow', name: '不死鳥の弓', type: 'equipment', baseValue: 590, image: '/art/items/phoenix_bow.png' },

  // ===== Rank 8: 最終レシピ (10種) =====
  legendary_blade: { id: 'legendary_blade', name: '伝説の刃', type: 'equipment', baseValue: 800, image: '/art/items/legendary_blade.png' },
  world_tree_staff: { id: 'world_tree_staff', name: '世界樹の杖', type: 'equipment', baseValue: 850, image: '/art/items/world_tree_staff.png' },
  genesis_armor: { id: 'genesis_armor', name: '始原の鎧', type: 'equipment', baseValue: 900, image: '/art/items/genesis_armor.png' },
  time_blade: { id: 'time_blade', name: '時渡りの剣', type: 'equipment', baseValue: 820, image: '/art/items/time_blade.png' },
  primordial_crown: { id: 'primordial_crown', name: '始原の冠', type: 'accessory', baseValue: 780, image: '/art/items/primordial_crown.png' },
  eternity_ring: { id: 'eternity_ring', name: '永遠の指輪', type: 'accessory', baseValue: 750, image: '/art/items/eternity_ring.png' },
  cosmos_bow: { id: 'cosmos_bow', name: '星界弓コスモス', type: 'equipment', baseValue: 830, image: '/art/items/cosmos_bow.png' },
  panacea: { id: 'panacea', name: '万象の霊薬', type: 'consumable', baseValue: 600, image: '/art/items/panacea.png' },
