...
export const ItemBlueprints = {
  ...
  // --- Tier 1: 草原・基本 (10種) ---
  wood: { id: 'wood', name: '木材', type: 'material', tier: 1, baseValue: 4, image: '/art/items/wood.png' },
  stone: { id: 'stone', name: '石材', type: 'material', tier: 1, baseValue: 4, image: '/art/items/stone.png' },
  herb: { id: 'herb', name: '薬草', type: 'material', tier: 1, baseValue: 6, image: '/art/items/herb.png' },
...
/**
 * トレイト融合テーブル — 同じトレイトが素材間で重複した場合、1ランク上に昇格
 * キー: 元のトレイト名, 値: 昇格後のトレイト名
 * 最高ランクのトレイトは昇格先がないためテーブルに含めない
 */
