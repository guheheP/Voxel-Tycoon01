...
export const UpgradeDefs = [
  ...
  // ===== 📦 倉庫拡張 =====
  { id: 'storage_1', category: 'storage', name: '倉庫 拡張I', description: '倉庫容量 +40', icon: '📦', cost: 100, requiredRank: 1, effect: { type: 'inventory_capacity', value: 40 } },
  { id: 'storage_2', category: 'storage', name: '倉庫 拡張II', description: '倉庫容量 +40', icon: '📦', cost: 300, requiredRank: 2, effect: { type: 'inventory_capacity', value: 40 } },
  { id: 'storage_3', category: 'storage', name: '倉庫 拡張III', description: '倉庫容量 +60', icon: '📦', cost: 800, requiredRank: 4, effect: { type: 'inventory_capacity', value: 60 } },
  { id: 'storage_4', category: 'storage', name: '倉庫 拡張IV', description: '倉庫容量 +60', icon: '📦', cost: 2000, requiredRank: 6, effect: { type: 'inventory_capacity', value: 60 } },
  { id: 'storage_5', category: 'storage', name: '倉庫 拡張V', description: '倉庫容量 +80', icon: '📦', cost: 5000, requiredRank: 8, effect: { type: 'inventory_capacity', value: 80 } },
