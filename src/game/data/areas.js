...
export const AreaDefs = {
  plains: {
    ...
    traitPool: ['丈夫', '軽い', '硬い', '幸運', '薬草の香り', '滋養', '闘志', '堅固', '活力', '光る', '水溶性'],
    dropCountMin: 1,
    dropCountMax: 2,
    qualityMin: 20,
    qualityMax: 45,
  ...
  cave: {
    ...
    traitPool: ['硬い', '光る', '堅固', '防御力+', '先制', '幸運', '強運', '薬草の香り', '命の露'],
    dropCountMin: 1,
    dropCountMax: 2,
    qualityMin: 20,
    qualityMax: 55,
  ...
  forest: {
    ...
    traitPool: ['HP回復+', '採取量UP', '猛毒', '燃えやすい', '体力強化', '癒しの力', '命の露', '練磨'],
    dropCountMin: 1,
    dropCountMax: 3,
    qualityMin: 25,
    qualityMax: 65,
  ...
  volcano: {
    ...
    traitPool: ['攻撃力+', '攻撃力++', '燃えやすい', '猛毒', '雷撃', '疾走', '癒しの力'],
    dropCountMin: 1,
    dropCountMax: 2,
    qualityMin: 30,
    qualityMax: 75,
  ...
  dragon_nest: {
    ...
    traitPool: ['攻撃力++', '防御力++', '聖なる力', '風の加護', '吸血', '天運'],
    dropCountMin: 1,
    dropCountMax: 3,
    qualityMin: 40,
    qualityMax: 90,
  ...
  sky_tower: {
    ...
    traitPool: ['攻撃力++', '防御力++', '風の加護', '聖なる力', '熟練', '疾走'],
    dropCountMin: 2,
    dropCountMax: 3,
    qualityMin: 50,
    qualityMax: 95,
