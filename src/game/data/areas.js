...
export const AreaDefs = {
  plains: {
    ...
    traitPool: ['丈夫', '軽い', '硬い', '幸運', '薬草の香り', '滋養'],
    dropCountMin: 1,
    dropCountMax: 2,
    qualityMin: 20,
    qualityMax: 45,
  ...
  cave: {
    ...
    traitPool: ['硬い', '光る', '防御力+', '先制', '幸運', '薬草の香り', '命の露'],
    dropCountMin: 1,
    dropCountMax: 2,
    qualityMin: 20,
    qualityMax: 55,
  ...
  forest: {
    ...
    traitPool: ['HP回復+', '採取量UP', '猛毒', '軽い', '風の加護', '体力強化', '強運', '癒しの力', '命の露'],
    dropCountMin: 1,
    dropCountMax: 3,
    qualityMin: 25,
    qualityMax: 65,
  ...
  volcano: {
    ...
    traitPool: ['攻撃力+', '攻撃力++', '燃えやすい', '丈夫', '雷撃', '疾走', '強運', '癒しの力'],
    dropCountMin: 1,
    dropCountMax: 2,
    qualityMin: 30,
    qualityMax: 75,
  ...
  deep_sea: {
    ...
    traitPool: ['防御力++', '水溶性', 'HP回復+', '光る', '鉄壁', '慈愛', '生命の雫'],
    dropCountMin: 1,
    dropCountMax: 3,
    qualityMin: 35,
    qualityMax: 80,
  ...
  dragon_nest: {
    ...
    traitPool: ['攻撃力++', '攻撃力+++', '防御力++', '聖なる力', '光る', '再生', '聖癒'],
    dropCountMin: 1,
    dropCountMax: 3,
    qualityMin: 40,
    qualityMax: 90,
  ...
  sky_tower: {
    ...
    traitPool: ['攻撃力+++', '防御力+++', '風の加護', '星の輝き', '聖なる力', '武神'],
    dropCountMin: 2,
    dropCountMax: 3,
    qualityMin: 50,
    qualityMax: 95,
  ...
  time_corridor: {
    ...
    traitPool: ['時の祝福', '星の輝き', '混沌', '攻撃力+++', '防御力+++', '売値UP+', '不死鳥'],
    dropCountMin: 2,
    dropCountMax: 4,
    qualityMin: 60,
    qualityMax: 100,
